...
To create a new public identity for a line, use the `test.add_public_identity` function.  The returned endpoint will share a private ID with the passed in one but will have it's own public identity.
